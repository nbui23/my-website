...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Maxis Studios - Electronic Arts (EA)}{Software Developer Intern $|$ Python, AI, ML}{May 2025}
        \resumeItemListStart
            \resumeItem{Will be working on test automation for the Sims franchise during Summer 2025}
        \resumeItemListEnd
