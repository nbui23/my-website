...
\section{\textbf{\Large Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Electronic Arts (EA)}{Software Developer Intern $|$ AI Agents, Test Automation}{May 2025 - Present}
        \resumeItemListStart
            \resumeItem{Developing an AI agent-powered testing tool for a new Sims title, enabling QA to run tests via natural language, with agents that autonomously explore game systems and detect bugs}
        \resumeItemListEnd
